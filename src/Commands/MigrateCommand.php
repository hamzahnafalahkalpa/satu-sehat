...
class MigrateCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'satu-sehat:migrate {--seed}';
     ...
     * @var string
     */
    protected $description = 'Run migrations for the SatuSehat project';
    ...
    public function handle()
    {
        ...
        $this->info("Migrations for SatuSehat project have been successfully executed.");
